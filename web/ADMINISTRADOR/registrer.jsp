<%-- 
    Document   : registrer
    Created on : 6/11/2018, 11:46:03 PM
    Author     : PC
--%>
...
<body>
    ...
    <section class="cards-section5">
     <a href="game.jsp" class="text-dark"><div class="card card-5" style="width: 18rem;">
            <div class="card-body">
                <span><i class="fas fass fa-gamepad"></i></span>
                <h5 class="card-title text-center text-danger mt-5">GAMES</h5>
            </div></a>
        </div>
       <a href="dev.jsp" class="text-dark"><div class="card card-5" style="width: 18rem;">
            <div class="card-body">
                <span><i class="fas fass fa-building"></i></span>
                <h5 class="card-title text-center text-danger mt-5">COMPANY</h5>
            </div>
        </div></a>
    </section>
    <!-- BOOTSTAP -->
