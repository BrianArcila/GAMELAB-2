<%-- 
    Document   : audit
    Created on : 6/11/2018, 11:44:33 PM
    Author     : PC
--%>
...
<body>
    ...
    <section class="cards-section5">
        <a href="logs.jsp" class="text-dark">
            <div class="card card-5" style="width: 18rem;">
                <div class="card-body">
                    <span><i class="fas fass fa-info-circle"></i></span>
                    <h5 class="card-title text-center text-danger mt-5">LOGS</h5>
                </div>
            </div>
        </a>
        <a href="permits.jsp" class="text-dark">
            <div class="card card-5" style="width: 18rem;">
                <div class="card-body">
                    <span><i class="fas fass fa-plus-square"></i></span>
                    <h5 class="card-title text-center text-danger mt-5">PERMITS</h5>
                </div>
            </div>
        </a>
    </section>
